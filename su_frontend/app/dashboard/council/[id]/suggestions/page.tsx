...
export default function CouncilSuggestionsPage() {
    ...
    if (suggestionsLoading || councilLoading) return <div className="flex h-[50vh] items-center justify-center"><Loader2 className="w-8 h-8 text-primary animate-spin" /></div>;
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {displayedSuggestions.length > 0 ? (
                    ...
                    <div className="col-span-full py-12 flex flex-col items-center justify-center text-txtcolor-300 bg-secondarybg/30 rounded-xl border-2 border-dashed border-secondarybg">
