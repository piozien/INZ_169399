...
export const fetchCouncilBudget = async (councilId: string): Promise<CouncilBudgetResponseDto> =>
...
export const addTransaction = async (
    budgetId: string,
    data: CouncilTransactionRequestDto
): Promise<CouncilTransactionResponseDto> =>
    apiFetch<CouncilTransactionResponseDto>(`/councils/budget/${budgetId}/transactions`, {
        method: 'POST',
        body: JSON.stringify(data),
...
export const updateTransaction = async (
    ...
    apiFetch<CouncilTransactionResponseDto>(`/councils/budget/transactions/${transactionId}`, {
        method: 'PUT',
        body: JSON.stringify(data),
    });

export const deleteTransaction = async (transactionId: string): Promise<void> =>
    apiFetch<void>(`/councils/budget/transactions/${transactionId}`, { method: 'DELETE' });
