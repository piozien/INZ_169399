...
export const useCouncilEvents = (councilId: string) => {
    ...
    const deleteMutation = useMutation({
        ...
        onError: (err) => alert('Błąd usuwania: ' + (err instanceof Error ? err.message : '')),
    });
    ...
    const statusMutation = useMutation({
        ...
        onError: () => alert('Błąd zmiany statusu.'),
    });
    ...
    return {
        ...
        handleDelete,
        handleDecision,
        isProcessing: statusMutation.isPending || deleteMutation.isPending,
