                        ...
                        <thead className="bg-secondarybg text-txtcolor-300 sticky top-0 z-20 text-xs font-bold uppercase">
                            <tr>
                                ...
                                {visibleRoles.map((role) => (
                                    <th
                                        key={role}
                                        className="border-border border-border/50 min-w-[120px] border-b border-l px-4 py-4 text-center"
                                    >
                                        <div className="flex flex-col items-center">
                                            <span className="max-w-[100px] break-words">
                                                {role.replace('_', ' ')}
                                            </span>
                                        </div>
                                    </th>
                                        ...
                                        return (
                                            ...
                                            >
                                                <button
                                                    ...
                                                    disabled={isCritical}
                                                    className={`mx-auto flex h-9 w-9 items-center justify-center rounded-lg transition-all ${isCritical ? 'bg-secondarybg cursor-not-allowed opacity-50' : ''} ${!isCritical && hasPermission ? 'bg-success text-darkgray scale-100 shadow-sm hover:opacity-90' : ''} ${!isCritical && !hasPermission ? 'bg-inputbg text-txtcolor-300 hover:bg-secondarybg hover:text-foreground scale-90 hover:scale-100' : ''} `}
                                                    title={
                                                        isCritical
