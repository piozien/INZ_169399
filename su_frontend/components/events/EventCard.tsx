            ...
            <div className="p-5 flex flex-col flex-1 relative">
                ...
                <div className="flex justify-between items-start mb-4">
                    <div className="flex flex-col">
                        <span className="text-4xl font-black text-foreground tracking-tighter group-hover:text-secondary transition-colors duration-300">
                ...
                <div className="mt-auto space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="p-2 rounded-lg bg-inputbg text-secondary shrink-0 group-hover:bg-secondary group-hover:text-darkgray transition-colors duration-300">
                            <Clock size={16} strokeWidth={2.5} />
                        </div>
                        <span className="text-sm font-medium text-txtcolor-300 group-hover:text-foreground transition-colors">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-txtcolor-300 truncate group-hover:text-foreground transition-colors">
                            {event.location || "Online"}
                        </span>
                    </div>
                </div>

                <div className="absolute bottom-5 right-5 opacity-0 transform translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-secondary">
                    <ArrowRight size={24} />
                </div>
            </div>
        </div>
